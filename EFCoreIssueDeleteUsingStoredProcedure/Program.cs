...
class ReproDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer(@"Server=tcp:localhost,1433;Initial Catalog=EFCoreIssueDeleteUsingStoredProcedure;Persist Security Info=True;Integrated Security=true;Encrypt=True;TrustServerCertificate=True");
    }
}
